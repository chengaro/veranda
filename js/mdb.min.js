...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
  ...
  if (!t.jQuery) {
    ...
    i.isWindow = function (t) {
      ...
      init: function (t) {
        ...
        var e = this[0], t = t.apply(e), n = this.offset(), o = /^(?:body|html)$/i.test(t.nodeName) ? {top: 0, left: 0} : i(t).offset();
  ...
  return function (t, e, i, n) {
    ...
    if (!(7 >= d)) {
      ...
      var y = function () {
        ...
        function i(i, n) {
          var o = {dx: i.v, dv: t(i)}, a = e(i, .5 * n, o), r = e(i, .5 * n, a), s = e(i, n, r), l = 1 / 6 * (o.dx + 2 * (a.dx + r.dx) + s.dx), c = 1 / 6 * (o.dv + 2 * (a.dv + r.dv) + s.dv);
      ...
      var x = function () {
        ...
        function r() {
          function t(t) {
            ...
            function m() {
              var t = {myParent: r.parentNode || i.body, position: b.getPropertyValue(r, "position"), fontSize: b.getPropertyValue(r, "fontSize")}, n = t.position === L.lastPosition && t.myParent === L.lastParent, o = t.fontSize === L.lastFontSize;
            ...
            if ("scroll" === M) {
              ...
              for (var E in a(r).tweensContainer && !0 === a(r).isAnimating && (_ = a(r).tweensContainer), u.each(y, function (t, e) {
                ...
                if (a(r).isSVG || "tween" === z || !1 !== b.Names.prefixCheck(z)[1] || b.Normalizations.registered[z] !== n) {
                  ...
                  d[E] = {rootPropertyValue: N, startValue: V, currentValue: V, endValue: $, unitType: j, easing: W}, v.debug && console.log("tweensContainer (" + E + "): " + JSON.stringify(d[E]), r)
        ...
        if (p.isWrapped(this) ? (d = !1, f = 0, g = this, h = this) : (d = !0, f = 1, g = k ? arguments[0].elements || arguments[0].e : arguments[0]), g = o(g)) {
          ...
          var D, E, L = {lastParent: null, lastPosition: null, lastFontSize: null, lastPercentToPxWidth: null, lastPercentToPxHeight: null, lastEmToPx: null, remToPx: null, vwToPx: null, vhToPx: null}, R = [];
      ...
      return v.State.isMobile || i.hidden === n || i.addEventListener("visibilitychange", function () {
        ...
        v.Redirects["slide" + e] = function (t, i, o, a, r, s) {
          var l = u.extend({}, i), c = l.begin, d = l.complete, h = {height: "", marginTop: "", marginBottom: "", paddingTop: "", paddingBottom: ""}, p = {};
    ...
    1: [function (t, e, i) {
      ...
      a.prototype = {
        isValid: function () {
          ...
          var i = t, n = void 0 === e ? .5 : e, o = 2 * n - 1, a = this.alpha() - i.alpha(), r = ((o * a == -1 ? o : (o + a) / (1 + o * a)) + 1) / 2, s = 1 - r;
      ...
      function h(t) {
        var e = t[0] / 60, i = t[1] / 100, n = t[2] / 100, o = Math.floor(e) % 6, a = e - Math.floor(e), r = 255 * n * (1 - i), s = 255 * n * (1 - i * a), l = 255 * n * (1 - i * (1 - a));
        n *= 255;
        switch (o) {
          case 0:
            return [n, l, r];
      ...
      n._set("bar", {hover: {mode: "label"}, scales: {xAxes: [{type: "category", categoryPercentage: .8, barPercentage: .9, offset: !0, gridLines: {offsetGridLines: !0}}], yAxes: [{type: "linear"}]}}), n._set("horizontalBar", {
        hover: {mode: "index", axis: "y"},
        scales: {xAxes: [{type: "linear", position: "bottom"}], yAxes: [{position: "left", type: "category", categoryPercentage: .8, barPercentage: .9, offset: !0, gridLines: {offsetGridLines: !0}}]},
        ...
        t.controllers.bar = t.DatasetController.extend({
          dataElementType: o.Rectangle, initialize: function () {
            ...
            var n = this, o = t._model, a = n.getValueScale(), r = a.getBasePixel(), s = a.isHorizontal(), l = n._ruler || n.getRuler(), c = n.calculateBarValuePixels(n.index, e), u = n.calculateBarIndexPixels(n.index, e, l);
            ...
            }(e, i, n), r = this.getStackIndex(t, this.getMeta().stack), s = o.start + o.chunk * r + o.chunk / 2, l = Math.min(a.valueOrDefault(n.maxBarThickness, 1 / 0), o.chunk * o.ratio);
            ...
            var e = this.chart.data.datasets[t._datasetIndex], i = t._index, n = t.custom || {}, o = t._model, r = this.chart.options.elements.rectangle;
      ...
      var n = t(25), o = t(40), a = t(45);
      n._set("bubble", {
        hover: {mode: "single"}, scales: {xAxes: [{type: "linear", position: "bottom", id: "x-axis-0"}], yAxes: [{type: "linear", position: "left", id: "y-axis-0"}]}, tooltips: {
          callbacks: {
            title: function () {
              return ""
            }, label: function (t, e) {
        ...
        t.controllers.bubble = t.DatasetController.extend({
          dataElementType: o.Point, update: function (t) {
            ...
            var n = this, o = n.getMeta(), a = t.custom || {}, r = n.getScaleForId(o.xAxisID), s = n.getScaleForId(o.yAxisID), l = n._resolveElementOptions(t, e), c = n.getDataset().data[e], u = n.index, d = i ? r.getPixelForDecimal(.5) : r.getPixelForValue("object" == typeof c ? c : NaN, e, u), h = i ? s.getBasePixel() : s.getPixelForValue(c, e, u);
      ...
      n._set("doughnut", {
          ...
          labels: {
            generateLabels: function (t) {
              ...
              return e.labels.length && e.datasets.length ? e.labels.map(function (i, n) {
                var o = t.getDatasetMeta(0), r = e.datasets[0], s = o.data[n], l = s && s.custom || {}, c = a.valueAtIndexOrDefault, u = t.options.elements.arc;
        ...
        t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
          dataElementType: o.Arc, linkScales: a.noop, getRingIndex: function (t) {
            ...
            var e = this, i = e.chart, n = i.chartArea, o = i.options, r = o.elements.arc, s = n.right - n.left - r.borderWidth, l = n.bottom - n.top - r.borderWidth, c = Math.min(s, l), u = {x: 0, y: 0}, d = e.getMeta(), h = o.cutoutPercentage, p = o.circumference;
            if (p < 2 * Math.PI) {
              var f = o.rotation % (2 * Math.PI), m = (f += 2 * Math.PI * (f >= Math.PI ? -1 : f < -Math.PI ? 1 : 0)) + p, g = {x: Math.cos(f), y: Math.sin(f)}, v = {x: Math.cos(m), y: Math.sin(m)}, y = f <= 0 && m >= 0 || f <= 2 * Math.PI && 2 * Math.PI <= m, b = f <= .5 * Math.PI && .5 * Math.PI <= m || f <= 2.5 * Math.PI && 2.5 * Math.PI <= m, x = f <= -Math.PI && -Math.PI <= m || f <= Math.PI && Math.PI <= m,
                w = f <= .5 * -Math.PI && .5 * -Math.PI <= m || f <= 1.5 * Math.PI && 1.5 * Math.PI <= m, k = h / 100, S = {x: x ? -1 : Math.min(g.x * (g.x < 0 ? 1 : k), v.x * (v.x < 0 ? 1 : k)), y: w ? -1 : Math.min(g.y * (g.y < 0 ? 1 : k), v.y * (v.y < 0 ? 1 : k))}, C = {x: y ? 1 : Math.max(g.x * (g.x > 0 ? 1 : k), v.x * (v.x > 0 ? 1 : k)), y: b ? 1 : Math.max(g.y * (g.y > 0 ? 1 : k), v.y * (v.y > 0 ? 1 : k))}, T = {width: .5 * (C.x - S.x), height: .5 * (C.y - S.y)};
            ...
            var n = this, o = n.chart, r = o.chartArea, s = o.options, l = s.animation, c = (r.left + r.right) / 2, u = (r.top + r.bottom) / 2, d = s.rotation, h = s.rotation, p = n.getDataset(), f = i && l.animateRotate ? 0 : t.hidden ? 0 : n.calculateCircumference(p.data[e]) * (s.circumference / (2 * Math.PI)), m = i && l.animateScale ? 0 : n.innerRadius, g = i && l.animateScale ? 0 : n.outerRadius, v = a.valueAtIndexOrDefault;
            a.extend(t, {_datasetIndex: n.index, _index: e, _model: {x: c + o.offsetX, y: u + o.offsetY, startAngle: d, endAngle: h, circumference: f, outerRadius: g, innerRadius: m, label: v(p.label, e, o.data.labels[e])}});
            var y = t._model;
      ...
      var n = t(25), o = t(40), a = t(45);
      n._set("polarArea", {
        scale: {type: "radialLinear", angleLines: {display: !1}, gridLines: {circular: !0}, pointLabels: {display: !1}, ticks: {beginAtZero: !0}}, animation: {animateRotate: !0, animateScale: !0}, startAngle: -.5 * Math.PI, legendCallback: function (t) {
          var e = [];
          e.push('<ul class="' + t.id + '-legend">');
          var i = t.data, n = i.datasets, o = i.labels;
          if (n.length) for (var a = 0; a < n[0].data.length; ++a) e.push('<li><span style="background-color:' + n[0].backgroundColor[a] + '"></span>'), o[a] && e.push(o[a]), e.push("</li>");
          ...
          labels: {
            generateLabels: function (t) {
              var e = t.data;
              return e.labels.length && e.datasets.length ? e.labels.map(function (i, n) {
                var o = t.getDatasetMeta(0), r = e.datasets[0], s = o.data[n].custom || {}, l = a.valueAtIndexOrDefault, c = t.options.elements.arc;
        ...
        t.controllers.polarArea = t.DatasetController.extend({
          dataElementType: o.Arc, linkScales: a.noop, update: function (t) {
            var e = this, i = e.chart, n = i.chartArea, o = e.getMeta(), r = i.options, s = r.elements.arc, l = Math.min(n.right - n.left, n.bottom - n.top);
            ...
            var v = s.startAngle, y = t.hidden ? 0 : c.getDistanceFromCenterForValue(r.data[e]), b = v + d * f, x = b + (t.hidden ? 0 : d), w = l.animateScale ? 0 : c.getDistanceFromCenterForValue(r.data[e]);
            a.extend(t, {_datasetIndex: n.index, _index: e, _scale: c, _model: {x: h, y: p, innerRadius: 0, outerRadius: i ? w : y, startAngle: i && l.animateRotate ? v : b, endAngle: i && l.animateRotate ? v : x, label: a.valueAtIndexOrDefault(u, e, u[e])}}), n.removeHoverStyle(t), t.pivot()
          }, removeHoverStyle: function (e) {
            t.DatasetController.prototype.removeHoverStyle.call(this, e, this.chart.options.elements.arc)
      ...
      n._set("radar", {scale: {type: "radialLinear"}, elements: {line: {tension: 0}}}), e.exports = function (t) {
        t.controllers.radar = t.DatasetController.extend({
          datasetElementType: o.Line, dataElementType: o.Point, linkScales: a.noop, update: function (t) {
            var e = this, i = e.getMeta(), n = i.dataset, o = i.data, r = n.custom || {}, s = e.getDataset(), l = e.chart.options.elements.line, c = e.chart.scale;
            ...
            var n = this, o = t.custom || {}, r = n.getDataset(), s = n.chart.scale, l = n.chart.options.elements.point, c = s.getPointPositionForValue(e, r.data[e]);
            ...
            a.each(e.data, function (i, n) {
              var o = i._model, r = a.splineCurve(a.previousItem(e.data, n, !0)._model, o, a.nextItem(e.data, n, !0)._model, o.tension);
            ...
            var e = this.chart.data.datasets[t._datasetIndex], i = t.custom || {}, n = t._index, o = t._model, r = this.chart.options.elements.point;
      ...
      "use strict";
      t(25)._set("scatter", {
        hover: {mode: "single"}, scales: {xAxes: [{id: "x-axis-1", type: "linear", position: "bottom"}], yAxes: [{id: "y-axis-1", type: "linear", position: "left"}]}, showLines: !1, tooltips: {
          callbacks: {
            title: function () {
              return ""
            }, label: function (t) {
      ...
      e.exports = function (t) {
        ...
        t.types = {}, t.instances = {}, t.controllers = {}, o.extend(t.prototype, {
          construct: function (e, i) {
            ...
            var e = this, i = e.options, n = e.canvas, a = i.maintainAspectRatio && e.aspectRatio || null, r = Math.max(0, Math.floor(o.getMaximumWidth(n))), s = Math.max(0, Math.floor(a ? r / a : o.getMaximumHeight(n)));
            ...
            var i = this, n = i.options, a = i.scales || {}, r = [], s = Object.keys(a).reduce(function (t, e) {
              return t[e] = !1, t
            }, {});
            ...
            var i, n, a = this;
            if (e && "object" == typeof e || (e = {duration: e, lazy: arguments[1]}), n = (i = a).options, o.each(i.scales, function (t) {
              r.removeBox(i, t)
              ...
              o.each(a.data.datasets, function (t, e) {
                ...
                t.reset()
              }), a.updateDatasets(), a.tooltip.initialize(), a.lastActive = [], l.notify(a, "afterUpdate"), a._bufferedRender ? a._bufferedRequest = {duration: e.duration, easing: e.easing, lazy: e.lazy} : a.render(e)
            }
      ...
      e.exports = function (t) {
        ...
        t.DatasetController = function (t, e) {
          ...
          datasetElementType: null, dataElementType: null, initialize: function (t, e) {
            ...
            var i = this.chart.data.datasets[t._datasetIndex], o = t._index, a = t.custom || {}, r = n.valueAtIndexOrDefault, s = t._model;
            ...
            var e = this.chart.data.datasets[t._datasetIndex], i = t._index, o = t.custom || {}, a = n.valueAtIndexOrDefault, r = n.getHoverColor, s = t._model;
      ...
      e.exports = function (t) {
        ...
        function r(t, n, o) {
          var a = document.defaultView, r = t.parentNode, s = a.getComputedStyle(t)[n], l = a.getComputedStyle(r)[n], c = i(s), u = i(l), d = Number.POSITIVE_INFINITY;
        ...
        a.configMerge = function () {
          ...
          var o = t.skip ? e : t, a = e, r = i.skip ? e : i, s = Math.sqrt(Math.pow(a.x - o.x, 2) + Math.pow(a.y - o.y, 2)), l = Math.sqrt(Math.pow(r.x - a.x, 2) + Math.pow(r.y - a.y, 2)), c = s / (s + l), u = l / (s + l), d = n * (c = isNaN(c) ? 0 : c), h = n * (u = isNaN(u) ? 0 : u);
      ...
      e.exports = {
        defaults: {}, addBox: function (t, e) {
          ...
          if (t) {
            var r = t.options.layout || {}, s = n.options.toPadding(r.padding), l = s.left, c = s.right, u = s.top, d = s.bottom, h = o(t.boxes, "left"), p = o(t.boxes, "right"), f = o(t.boxes, "top"), m = o(t.boxes, "bottom"), g = o(t.boxes, "chartArea");
            a(h, !0), a(p, !1), a(f, !0), a(m, !1);
            var v = e - l - c, y = i - u - d, b = y / 2, x = (e - v / 2) / (h.length + p.length), w = (i - b) / (f.length + m.length), k = v, S = y, C = [];
            ...
            var $ = l + E, W = u + L;
            n.each(h.concat(f), z), $ += k, W += S, n.each(p, z), n.each(m, z), t.chartArea = {left: A, top: O, right: A + k, bottom: O + S}, n.each(g, function (e) {
      ...
      n._set("scale", {
        ...
        function i(t) {
          var e = a.valueOrDefault, i = n.global, o = e(t.fontSize, i.defaultFontSize), r = e(t.fontStyle, i.defaultFontStyle), s = e(t.fontFamily, i.defaultFontFamily);
        ...
        t.Scale = o.extend({
          getPadding: function () {
            ...
            var t = this, n = t.minSize = {width: 0, height: 0}, o = s(t._ticks), l = t.options, c = l.ticks, u = l.scaleLabel, d = l.gridLines, h = l.display, p = t.isHorizontal(), f = i(c), m = l.gridLines.tickMarkLength;
            ...
            if (c.display && h) {
              var v = a.longestText(t.ctx, f.font, o, t.longestTextCache), y = a.numberOfLabelLines(o), b = .5 * f.size, x = t.options.ticks.padding;
              if (p) {
            ...
            if (e.isHorizontal()) {
              var n = (e.width - (e.paddingLeft + e.paddingRight)) / Math.max(e._ticks.length - (i ? 0 : 1), 1), o = n * t + e.paddingLeft;
              i && (o += n / 2);
            ...
            if (o.display) {
              var s = e.ctx, c = n.global, u = o.ticks.minor, d = o.ticks.major || u, h = o.gridLines, p = o.scaleLabel, f = 0 !== e.labelRotation, m = e.isHorizontal(), g = u.autoSkip ? e._autoSkip(e.getTicks()) : e.getTicks(), v = a.valueOrDefault(u.fontColor, c.defaultFontColor), y = i(u), b = a.valueOrDefault(d.fontColor, c.defaultFontColor), x = i(d), w = h.drawTicks ? h.tickMarkLength : 0, k = a.valueOrDefault(p.fontColor, c.defaultFontColor), S = i(p), C = a.options.toPadding(p.padding),
                T = a.toRadians(e.labelRotation), M = [], I = e.options.gridLines.lineWidth, P = "right" === o.position ? e.right : e.right - I - w, A = "right" === o.position ? e.right + w : e.right, _ = "bottom" === o.position ? e.top + I : e.bottom - w - I, O = "bottom" === o.position ? e.top + I + w : e.bottom + I;
              if (a.each(g, function (i, n) {
                if (!a.isNullOrUndef(i.label)) {
                  ...
                  M.push({tx1: v, ty1: y, tx2: b, ty2: x, x1: k, y1: S, x2: C, y2: D, labelX: E, labelY: L, glWidth: r, glColor: s, glBorderDash: d, glBorderDashOffset: p, rotation: -1 * T, label: R, major: i.major, textBaseline: $, textAlign: F})
                }
              }), a.each(M, function (t) {
              ...
              if (h.drawBorder) {
                ...
                var $ = e.left, W = e.right + I, V = e.top, z = e.bottom + I, N = a.aliasPixel(s.lineWidth);
      ...
      n._set("global", {
        ...
        t.Tooltip = o.extend({
          initialize: function () {
            ...
            var t = this._options.callbacks, e = t.beforeTitle.apply(this, arguments), n = t.title.apply(this, arguments), o = t.afterTitle.apply(this, arguments), a = [];
            ...
            var t = this._options.callbacks, e = t.beforeFooter.apply(this, arguments), n = t.footer.apply(this, arguments), o = t.afterFooter.apply(this, arguments), a = [];
            return a = i(a = i(a = i(a, e), n), o)
          }, update: function (e) {
            var i, n, o, s, l, c, u, d = this, h = d._options, p = d._model, f = d._model = r(h), m = d._active, g = d._data, v = {xAlign: p.xAlign, yAlign: p.yAlign}, y = {x: p.x, y: p.y}, b = {width: p.width, height: p.height}, x = {x: p.caretX, y: p.caretY};
            if (m.length) {
              f.opacity = 1;
              var w = [], k = [];
              x = t.Tooltip.positioners[h.position].call(d, m, d._eventPosition);
              var S = [];
              for (i = 0, n = m.length; i < n; ++i) S.push((o = m[i], s = void 0, l = void 0, void 0, void 0, s = o._xScale, l = o._yScale || o._scale, c = o._index, u = o._datasetIndex, {xLabel: s ? s.getLabelForIndex(c, u) : "", yLabel: l ? l.getLabelForIndex(c, u) : "", index: c, datasetIndex: u, x: o._model.x, y: o._model.y}));
              h.filter && (S = S.filter(function (t) {
                ...
                var o = t.x, a = t.y, r = t.caretSize, s = t.caretPadding, l = t.cornerRadius, c = i.xAlign, u = i.yAlign, d = r + s, h = l + s;
                ...
                }), p = 0, i.font = a.fontString(h, e._footerFontStyle, e._footerFontFamily), a.each(e.footer, f), {width: o += 2 * e.xPadding, height: n}
            ...
            if (0 !== e.opacity) {
              var i = {width: e.width, height: e.height}, n = {x: e.x, y: e.y}, o = Math.abs(e.opacity < .001) ? 0 : e.opacity, a = e.title.length || e.beforeBody.length || e.body.length || e.afterBody.length || e.footer.length;
      ...
      n._set("global", {elements: {point: {radius: 3, pointStyle: "circle", backgroundColor: r, borderColor: r, borderWidth: 1, hitRadius: 1, hoverRadius: 4, hoverBorderWidth: 1}}}), e.exports = o.extend({
        inRange: function (t, e) {
          ...
          var e = this._view, i = this._model, o = this._chart.ctx, s = e.pointStyle, l = e.radius, c = e.x, u = e.y, d = a.color, h = 0;
      ...
      n._set("global", {elements: {rectangle: {backgroundColor: n.global.defaultColor, borderColor: n.global.defaultColor, borderSkipped: "bottom", borderWidth: 0}}}), e.exports = o.extend({
        draw: function () {
          ...
          if (l.horizontal ? (t = l.base, e = l.x, i = l.y - l.height / 2, n = l.y + l.height / 2, o = e > t ? 1 : -1, a = 1, r = l.borderSkipped || "left") : (t = l.x - l.width / 2, e = l.x + l.width / 2, i = l.y, o = 1, a = (n = l.base) > i ? 1 : -1, r = l.borderSkipped || "bottom"), c) {
            var u = Math.min(Math.abs(t - e), Math.abs(i - n)), d = (c = c > u ? u : c) / 2, h = t + ("left" !== r ? d * o : 0), p = e + ("right" !== r ? -d * o : 0), f = i + ("top" !== r ? d * a : 0), m = n + ("bottom" !== r ? -d * a : 0);
      ...
      "use strict";
      var n = t(45), o = "$chartjs", a = "chartjs-", r = a + "render-monitor", s = a + "render-animation", l = ["animationstart", "webkitAnimationStart"], c = {touchstart: "mousedown", touchmove: "mousemove", touchend: "mouseup", pointerenter: "mouseenter", pointerdown: "mousedown", pointermove: "mousemove", pointerup: "mouseup", pointerleave: "mouseout", pointerout: "mouseout"};
      ...
      function m(t, e, i) {
        var c, u, d, p, m = t[o] || (t[o] = {}), g = m.resizer = function (t) {
          var e = document.createElement("div"), i = a + "size-monitor", n = "position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;";
      ...
      var r = {
        dataset: function (t) {
          var e = t.fill, i = t.chart, n = i.getDatasetMeta(e), o = n && i.isDatasetVisible(e) && n.dataset._children || [], a = o.length || 0;
      ...
      var c = o.extend({
        initialize: function (t) {
          ...
          var t = this, e = t.options, i = e.labels, o = e.display, r = t.ctx, s = n.global, c = a.valueOrDefault, u = c(i.fontSize, s.defaultFontSize), d = c(i.fontStyle, s.defaultFontStyle), h = c(i.fontFamily, s.defaultFontFamily), p = a.fontString(u, d, h), f = t.legendHitBoxes = [], m = t.minSize, g = t.isHorizontal();
          if (g ? (m.width = t.maxWidth, m.height = o ? 10 : 0) : (m.width = o ? 10 : 0, m.height = t.maxHeight), o) if (r.font = p, g) {
            ...
            a.each(t.legendItems, function (t, e) {
              ...
              S + C > m.height && (w += k + i.padding, x.push(k), k = 0, S = 0), k = Math.max(k, n), S += C, f[e] = {left: 0, top: 0, width: n, height: u}
      ...
      var l = o.extend({
        initialize: function (t) {
          ...
          var t = this, e = a.valueOrDefault, i = t.options, o = i.display, r = e(i.fontSize, n.global.defaultFontSize), s = t.minSize, l = a.isArray(i.text) ? i.text.length : 1, c = a.options.toLineHeight(i.lineHeight, r), u = o ? l * c + 2 * i.padding : 0;
      ...
      e.exports = function (t) {
        var e = t.Scale.extend({
          getLabels: function () {
            ...
            var e = this, i = e.options.offset, n = Math.max(e._ticks.length - (i ? 0 : 1), 1), o = e.isHorizontal(), a = (o ? e.width : e.height) / n;
          ...
          determineDataLimits: function () {
            ...
            if (void 0 === s && o.each(n, function (t, e) {
              ...
              o.each(n, function (n, a) {
                var s = i.getDatasetMeta(a), c = [s.type, void 0 === e.stacked && void 0 === s.stack ? a : "", s.stack].join(".");
      ...
      e.exports = function (t) {
        ...
        t.LinearScaleBase = t.Scale.extend({
          getRightValue: function (e) {
            ...
            var t = this, e = t.options.ticks, i = t.getTickLimit(), o = {maxTicks: i = Math.max(2, i), min: e.min, max: e.max, stepSize: n.valueOrDefault(e.fixedStepSize, e.stepSize)}, a = t.ticks = function (t, e) {
              var i, o = [];
      ...
      e.exports = function (t) {
        var e = n.global, i = {
          display: !0, animate: !0, position: "chartArea", angleLines: {display: !0, color: "rgba(0, 0, 0, 0.1)", lineWidth: 1}, gridLines: {circular: !1}, ticks: {showLabelBackdrop: !0, backdropColor: "rgba(255,255,255,0.75)", backdropPaddingY: 2, backdropPaddingX: 2, callback: a.formatters.linear}, pointLabels: {
        ...
        function s(t) {
          var i = t.options.pointLabels, n = o.valueOrDefault(i.fontSize, e.defaultFontSize), a = o.valueOrDefault(i.fontStyle, e.defaultFontStyle), r = o.valueOrDefault(i.fontFamily, e.defaultFontFamily);
        ...
        var p = t.LinearScaleBase.extend({
          setDimensions: function () {
            ...
            this.options.pointLabels.display ? function (t) {
              var e, i, n, a = s(t), c = Math.min(t.height / 2, t.width / 2), u = {r: t.width, l: 0, t: t.height, b: 0}, d = {};
              t.ctx.font = a.font, t._pointLabelSizes = [];
              var h, p, f, m = r(t);
              for (e = 0; e < m; e++) {
                n = t.getPointPosition(e, c), h = t.ctx, p = a.size, f = t.pointLabels[e] || "", i = o.isArray(f) ? {w: o.longestText(h, h.font, f), h: f.length * p + 1.5 * (f.length - 1) * p} : {w: h.measureText(f).width, h: p}, t._pointLabelSizes[e] = i;
                var g = t.getIndexAngle(e), v = o.toDegrees(g) % 360, y = l(v, n.x, i.w, 0, 180), b = l(v, n.y, i.h, 90, 270);
            ...
            var n = e.l / Math.sin(i.l), o = Math.max(e.r - this.width, 0) / Math.sin(i.r), a = -e.t / Math.cos(i.t), r = -Math.max(e.b - this.height, 0) / Math.cos(i.b);
            ...
            if (i.display) {
              var h = t.ctx, p = this.getIndexAngle(0), f = l(a.fontSize, e.defaultFontSize), m = l(a.fontStyle, e.defaultFontStyle), g = l(a.fontFamily, e.defaultFontFamily), v = o.fontString(f, m, g);
              o.each(t.ticks, function (i, s) {
                ...
                for (var f = r(t) - 1; f >= 0; f--) {
                  ...
                  if (l.display) {
                    var g = t.getPointPosition(f, h + 5), v = o.valueAtIndexOrDefault(l.fontColor, f, e.defaultFontColor);
      ...
      var o = t(25), a = t(45), r = Number.MIN_SAFE_INTEGER || -9007199254740991, s = Number.MAX_SAFE_INTEGER || 9007199254740991, l = {
      ...
      function h(t, e, i, n) {
        var o = function (t, e, i) {
          ...
          return {lo: a, hi: null}
        }(t, e, i), a = o.lo ? o.hi ? o.lo : t[t.length - 2] : t[0], r = o.lo ? o.hi ? o.hi : t[t.length - 1] : t[1], s = r[e] - a[e], l = s ? (i - a[e]) / s : 0, c = (r[n] - a[n]) * l;
        return a[n] + c
      }
      ...
      e.exports = function (t) {
        var e = t.Scale.extend({
          initialize: function () {
            ...
            w.length && (w = d(w).sort(u), v = Math.min(v, w[0]), y = Math.max(y, w[w.length - 1])), b.length && (b = d(b).sort(u), v = Math.min(v, b[0]), y = Math.max(y, b[b.length - 1])), v = f(m.min, h) || v, y = f(m.max, h) || y, v = v === s ? +n().startOf(g) : v, y = y === r ? +n().endOf(g) + 1 : y, h.min = Math.min(v, y), h.max = Math.max(v + 1, y), h._horizontal = h.isHorizontal(), h._table = [], h._timestamps = {data: b, datasets: x, labels: w}
          }, buildTicks: function () {
            ...
            var i = this.chart.data, n = this.options.time, o = i.labels && t < i.labels.length ? i.labels[t] : "", r = i.datasets[e].data[t];
            ...
            var o = this.options, r = t.valueOf(), s = o.time.displayFormats, l = s[this._unit], c = this._majorUnit, u = s[c], d = t.clone().startOf(c).valueOf(), h = o.ticks.major, p = h.enabled && c && u && r === d, f = t.format(n || (p ? u : l)), m = p ? h : o.ticks.minor, g = a.valueOrDefault(m.callback, m.userCallback);
            return g ? g(f, e, i) : f
            ...
            var e = this, i = e._horizontal ? e.width : e.height, n = e._horizontal ? e.left : e.top, o = h(e._table, "time", t, "pos");
            ...
            var e = this, i = e._horizontal ? e.width : e.height, o = e._horizontal ? e.left : e.top, a = (i ? (t - o) / i : 0) * (e._offsets.left + 1 + e._offsets.left) - e._offsets.right, r = h(e._table, "pos", a, "time");
            return n(r)
          }, getLabelWidth: function (t) {
            var e = this.options.ticks, i = this.ctx.measureText(t).width, n = a.toRadians(e.maxRotation), r = Math.cos(n), s = Math.sin(n);
            return i * r + a.valueOrDefault(e.fontSize, o.global.defaultFontSize) * s
          }, getLabelCapacity: function (t) {
            var e = this, i = e.options.time.displayFormats.millisecond, o = e.tickFormatFunction(n(t), 0, [], i), a = e.getLabelWidth(o), r = e.isHorizontal() ? e.width : e.height, s = Math.floor(r / a);
            return s > 0 ? s : 1
          }
        });
  ...
  WOW = function () {
    return {
      init: function () {
        ...
        function o(t) {
          var e = t.getBoundingClientRect(), i = document.body, n = document.documentElement, o = window.pageYOffset || n.scrollTop || i.scrollTop, a = n.clientTop || i.clientTop || 0, r = e.top + o - a;
          return Math.round(r)
        }
  ...
  function u(t, e, i) {
    if (i) {
      ...
      var n = i.getAttribute("data-x"), o = i.getAttribute("data-y"), a = i.getAttribute("data-scale"), r = i.getAttribute("data-translate"), c = 350 - (Date.now() - Number(i.getAttribute("data-hold")));
  ...
  return t.init = function (t) {
    ...
    var i = (t = a(t)).length;
    if ((e = e || {}).wait = e.wait || 0, e.position = e.position || null, i) for (var n, o, s, c = {}, u = 0, d = {type: "mousedown", button: 1}, h = function (t, e) {
      return function () {
        l.hide(t, e)
      }
    }; u < i; u++) if (n = t[u], o = e.position || {x: n.clientWidth / 2, y: n.clientHeight / 2}, s = r(n), c.x = s.left + o.x, c.y = s.top + o.y, d.pageX = c.x, d.pageY = c.y, l.show(d, n), e.wait >= 0 && null !== e.wait) {
...
var _this = this;
(t => {
  const e = `${["text", "password", "email", "url", "tel", "number", "search", "search-md"].map(t => `input[type=${t}]`).join(", ")}, textarea`, i = t => {
  ...
  t(document).on("click.card", ".card", function (e) {
    if (t(this).find(".card-reveal").length) {
      const i = t(e.target), n = i.is(".card-reveal .card-title"), o = i.is(".card-reveal .card-title i"), a = i.is(".card .activator"), r = i.is(".card .activator i");
    ...
    return function () {
      ...
      function u(i) {
        ...
        if (void 0 !== i.optionsOverride && (a = t.extend(a, i.optionsOverride), r = i.optionsOverride.iconClass || r), !function (t, e) {
          ...
          o++, e = s(a, !0);
          var l = null, u = t("<div/>"), p = t("<div/>"), f = t("<div/>"), m = t("<div/>"), g = t(a.closeHtml), v = {intervalId: null, hideEta: null, maxHideTime: null}, y = {toastId: o, state: "visible", startTime: new Date, options: a, map: i};
        ...
        function b(e) {
          if (!t(":focus", u).length || e) return clearTimeout(v.intervalId), u[a.hideMethod]({
            duration: a.hideDuration, easing: a.hideEasing, complete: function () {
...
$(".smooth-scroll").on("click", "a", function () {
  ...
  if (void 0 !== t && 0 === t.indexOf("#")) {
    const e = $(this).attr("data-offset") ? $(this).attr("data-offset") : 0, i = $(this).closest("ul").attr("data-allow-hashes");
  ...
  t.fn.scrollTo = function (e) {
    ...
    this.each(function () {
      ...
      function s(e) {
        ...
        const s = window.innerHeight, l = i.innerHeight(), c = i.offset().left, u = i.offset().top - t(window).scrollTop();
        ...
        a.css({position: "absolute", top: i.position().top + f + m, left: p}), a.stop(!0, !0).css("opacity", 0).slideDown({
          queue: !1, duration: n.inDuration, easing: "easeOutCubic", complete() {
            t(this).css("height", "")
          }
  ...
  }, t.fn.dropdown.defaults = {inDuration: 300, outDuration: 225, constrain_width: !0, hover: !1, gutter: 0, belowOrigin: !1, alignment: "left"}, t(".dropdown-button").dropdown()
}(jQuery);
...
dropdownSelectors.on({
  ...
  var D = "ontouchstart" in t, E = A(t, "PointerEvent") !== n, L = D && /mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent), R = 25, F = 1, $ = 2, W = 4, V = 8, z = 1, N = 2, H = 4, j = 8, B = 16, Y = N | H, X = j | B, q = Y | X, U = ["x", "y"], Q = ["clientX", "clientY"];
  ...
  v(st, Z, {
    handler: function (t) {
      var e = ot[t.type];
      e & F && 0 === t.button && (this.pressed = !0), e & $ && 1 !== t.which && (e = W), this.pressed && (e & W && (this.pressed = !1), this.callback(this.manager, e, {pointers: [t], changedPointers: [t], pointerType: "mouse", srcEvent: t}))
    }
  });
  var lt = {pointerdown: F, pointermove: $, pointerup: W, pointercancel: V, pointerout: V}, ct = {2: "touch", 3: "pen", 4: "mouse", 5: "kinect"}, ut = "pointerdown", dt = "pointermove pointerup pointercancel";
  ...
  t.MSPointerEvent && !t.PointerEvent && (ut = "MSPointerDown", dt = "MSPointerMove MSPointerUp MSPointerCancel"), v(ht, Z, {
    handler: function (t) {
      var e = this.store, i = !1, n = t.type.toLowerCase().replace("ms", ""), o = lt[n], a = ct[t.pointerType] || t.pointerType, r = "touch" == a, s = M(e, t.pointerId, "pointerId");
      o & F && (0 === t.button || r) ? s < 0 && (e.push(t), s = e.length - 1) : o & (W | V) && (i = !0), s < 0 || (e[s] = t, this.callback(this.manager, o, {pointers: e, changedPointers: [t], pointerType: a, srcEvent: t}), i && e.splice(s, 1))
    }
  });
  ...
  v(gt, Z, {
    handler: function (t) {
      ...
      if (e === F && (this.started = !0), this.started) {
        ...
        e & (W | V) && i[0].length - i[1].length == 0 && (this.started = !1), this.callback(this.manager, e, {pointers: i[0], changedPointers: i[1], pointerType: "touch", srcEvent: t})
      }
    }
  });
  ...
  var Ct = A(r.style, "touchAction"), Tt = Ct !== n, Mt = "auto", It = "manipulation", Pt = "none", At = "pan-x", _t = "pan-y", Ot = function () {
    if (!Tt) return !1;
  ...
  Vt.prototype = {
    ...
    defaults: {event: "swipe", threshold: 10, velocity: .3, direction: Y | X, pointers: 1}, getTouchAction: function () {
  ...
  t.fn.sideNav = function (c) {
    return this.each(function () {
      new class {
        constructor(i, n) {
          this.defaults = {MENU_WIDTH: e, edge: "left", closeOnClick: !1}, this.$element = i, this.options = this.assignOptions(n), this.menuOut = !1, this.$body = t("body"), this.$menu = t(`#${this.$element.attr("data-activates")}`), this.$sidenavOverlay = t("#sidenav-overlay"), this.$dragTarget = t('<div class="drag-target"></div>'), this.$body.append(this.$dragTarget), this.init()
        }
        ...
        updateOverlayOpacity(t) {
          let e;
          e = "left" === this.options.edge ? t / this.options.MENU_WIDTH : Math.abs((t - window.innerWidth) / this.options.MENU_WIDTH), this.$sidenavOverlay.velocity({opacity: e}, {duration: 10, queue: !1, easing: "easeOutQuad"})
        }
        ...
        panendEventHandler(t) {
          ...
          c > 0 && (c = 0), u < 0 && (u = 0), "left" === this.options.edge ? (this.menuOut && e <= o || e < a ? (0 !== c && this.translateMenuX([0, c], "300"), this.showSidenavOverlay()) : (!this.menuOut || e > o) && (this.enableScrolling(), this.translateMenuX([-1 * this.options.MENU_WIDTH - l, c], "200"), this.hideSidenavOverlay()), this.$dragTarget.css({
            ...
            right: "",
            left: 0
          })) : this.menuOut && e >= r || e > s ? (this.translateMenuX([0, u], "300"), this.showSidenavOverlay(), this.$dragTarget.css({width: "50%", right: "", left: 0})) : (!this.menuOut || e < r) && (this.enableScrolling(), this.translateMenuX([this.options.MENU_WIDTH + l, u], "200"), this.hideSidenavOverlay(), this.$dragTarget.css({width: "10px", right: 0, left: ""}))
        }
        ...
        hideSidenavOverlay() {
          this.$sidenavOverlay.velocity({opacity: 0}, {
            duration: 200, queue: !1, easing: "easeOutQuad", complete() {
              t(this).remove()
            }
        ...
        openOnClick() {
          this.$element.on("click", e => {
            if (e.preventDefault(), !0 === this.menuOut) this.menuOut = !1, this.removeMenu(); else {
              ...
              let e = [];
              e = "left" === this.options.edge ? [0, -1 * this.options.MENU_WIDTH] : [0, this.options.MENU_WIDTH], this.$menu.velocity({translateX: e}, {duration: 300, queue: !1, easing: "easeOutQuad"}), this.$sidenavOverlay.on("click", () => {
                this.removeMenu()
              })
            }
          })
        ...
        removeMenu(t) {
          this.$body.css({overflow: "", width: ""}), this.$menu.velocity({translateX: "left" === this.options.edge ? "-100%" : "100%"}, {
            duration: 200, queue: !1, easing: "easeOutCubic", complete: () => {
  ...
  t.fn.collapsible = function (e) {
    ...
    function n(e, i) {
      $panelHeaders = e.find("> li > .collapsible-header"), i.hasClass("active") ? i.parent().addClass("active") : i.parent().removeClass("active"), i.parent().hasClass("active") ? i.siblings(".collapsible-body").stop(!0, !1).slideDown({
        duration: 350, easing: "easeOutQuart", queue: !1, complete() {
          t(this).css("height", "")
        }
    ...
    return this.each(function () {
      ...
      t.data(this, "easyPieChart") || (n = t.extend({}, i, t(this).data()), t.data(this, "easyPieChart", new function (t, i) {
        ...
        var o = {}, a = 0, r = function () {
          ...
          "string" == typeof o.easing && "undefined" != typeof jQuery && jQuery.isFunction(jQuery.easing[o.easing]) ? o.easing = jQuery.easing[o.easing] : o.easing = n.easing, "number" == typeof o.animate && (o.animate = {duration: o.animate, enabled: !0}), "boolean" != typeof o.animate || o.animate || (o.animate = {
            duration: 1e3,
            enabled: o.animate
  ...
  t(document).on("change", e, function () {
    ...
    if (!r.length && function () {
      ...
      t(e).after(i)
    }(), r.find(".value").html(a.val()), n = !0, a.addClass("active"), r.hasClass("active") || r.velocity({height: "30px", width: "30px", top: "-20px", marginLeft: "-15px"}, {duration: 300, easing: "easeOutExpo"}), "input" !== o.type) {
    ...
    let a;
    if (n) {
      o.hasClass("active") || o.velocity({height: "30px", width: "30px", top: "-20px", marginLeft: "-15px"}, {duration: 300, easing: "easeOutExpo"}), a = void 0 === i.pageX || null === i.pageX ? i.originalEvent.touches[0].pageX - t(this).offset().left : i.pageX - t(this).offset().left;
  ...
  class e {
    ...
    buildSingleOption(e, i) {
      const n = e.is(":disabled") ? "disabled" : "", o = "optgroup-option" === i ? "optgroup-option" : "", a = e.data("icon"), r = e.data("fa") ? `<i class="fa fa-${e.data("fa")}"></i>` : "", s = e.attr("class"), l = a ? `<img alt="" src="${a}" class="${s}">` : "", c = this.isMultiple ? `<input type="checkbox" class="form-check-input" ${n}/><label></label>` : "";
    ...
    _onEachMaterialOptionClick(e, i, n) {
      ...
      if (this.isMultiple) {
        ...
        const t = Boolean(this.$nativeSelect.find("optgroup").length), e = this._isToggleAllPresent() ? o.index() - 1 : o.index();
    ...
    _onMaterialSelectKeydown(e) {
      const i = t(e.target), n = e.which === this.keyCodes.tab, o = e.which === this.keyCodes.esc, a = e.which === this.keyCodes.enter, r = e.which === this.keyCodes.arrowUp, s = e.which === this.keyCodes.arrowDown, l = this.$materialOptionsList.is(":visible");
    ...
    _handleArrowDownKey() {
      const t = this.$materialOptionsList.find("li").not(".disabled").not(".select-toggle-all").first(), e = this.$materialOptionsList.find("li").not(".disabled").not(".select-toggle-all").last(), i = this.$materialOptionsList.find("li.selected").length > 0, n = i ? this.$materialOptionsList.find("li.selected") : t, o = n.is(e) || !i ? n : n.next("li:not(.disabled)");
      this._selectSingleOption(o), this.$materialOptionsList.find("li").removeClass("active"), o.toggleClass("active")
    }

    _handleArrowUpKey() {
      const t = this.$materialOptionsList.find("li").not(".disabled").not(".select-toggle-all").first(), e = this.$materialOptionsList.find("li").not(".disabled").not(".select-toggle-all").last(), i = this.$materialOptionsList.find("li.selected").length > 0, n = i ? this.$materialOptionsList.find("li.selected") : e, o = n.is(t) || !i ? n : n.prev("li:not(.disabled)");
      this._selectSingleOption(o), this.$materialOptionsList.find("li").removeClass("active"), o.toggleClass("active")
    }
    ...
    _handleLetterKey(e) {
      let i = "";
      const n = String.fromCharCode(e.which).toLowerCase(), o = Object.keys(this.keyCodes).map(t => this.keyCodes[t]);
    ...
    _updateToggleAllOption() {
      const t = this.$materialOptionsList.find("li").not(".select-toggle-all, .disabled").find("[type=checkbox]"), e = t.filter(":checked"), i = this.$toggleAll.find("[type=checkbox]").is(":checked");
  ...
  function a(e, l, u, d) {
    if (!e) return a;
    var h = !1, p = {id: e.id || "P" + Math.abs(~~(Math.random() * new Date))}, f = u ? t.extend(!0, {}, u.defaults, d) : d || {}, m = t.extend({}, a.klasses(), f.klass), g = t(e), v = function () {
      return this.start()
    }, y = v.prototype = {
  ...
  return a.klasses = function (t) {
    return {picker: t = t || "picker", opened: t + "--opened", focused: t + "--focused", input: t + "__input", active: t + "__input--active", target: t + "__input--target", holder: t + "__holder", frame: t + "__frame", wrap: t + "__wrap", box: t + "__box"}
  }, a._ = {
    group: function (t) {
  ...
  function o(t, e) {
    ...
    n.settings = e, n.$node = t.$node, n.queue = {
      ...
      disable: "deactivate",
      enable: "activate"
    }, n.item = {}, n.item.clear = null, n.item.disable = (e.disable || []).slice(0), n.item.enable = -(!0 === (i = n.item.disable)[0] ? i.shift() : -1), n.set("min", e.min).set("max", e.max).set("now"), s ? n.set("select", s, {format: l, defaultValue: !0}) : n.set("select", null).set("highlight", n.item.now), n.key = {
  ...
  o.prototype.set = function (t, e, i) {
    ...
    var a;
    return (i = void 0 === i ? t : i) == -1 / 0 || i == 1 / 0 ? a = i : e.isPlainObject(i) && n.isInteger(i.pick) ? i = i.obj : e.isArray(i) ? (i = new Date(i[0], i[1], i[2]), i = n.isDate(i) ? i : this.create().obj) : i = n.isInteger(i) || n.isDate(i) ? this.normalize(new Date(i), o) : this.now(t, i, o), {year: a || i.getFullYear(), month: a || i.getMonth(), date: a || i.getDate(), day: a || i.getDay(), obj: a || i, pick: a || i.getTime()}
    ...
    var e, i, o = this, a = o.settings, r = o.item, s = r.now, l = r.select, c = r.highlight, u = r.view, d = r.disable, h = r.min, p = r.max, f = (e = (a.showWeekdaysFull ? a.weekdaysFull : a.weekdaysShort).slice(0), i = a.weekdaysFull.slice(0), a.firstDay && (e.push(e.shift()), i.push(i.shift())), n.node("thead", n.node("tr", n.group({
      min: 0, max: 6, i: 1, node: "th", item: function (t) {
        return [e[t], a.klass.weekdays, 'scope=col title="' + i[t] + '"']
      }
    })))), m = function (t) {
      return n.node("div", " ", a.klass["nav" + (t ? "Next" : "Prev")] + (t && u.year >= p.year && u.month >= p.month || !t && u.year <= h.year && u.month <= h.month ? " " + a.klass.navDisabled : ""), "data-nav=" + (t || -1) + " " + n.ariaAttr({role: "button", controls: o.$node[0].id + "_table"}) + ' title="' + (t ? a.labelMonthNext : a.labelMonthPrev) + '"')
    }, g = function () {
    ...
    return n.node("div", (a.selectYears ? v() + g() : g() + v()) + m() + m(1), a.klass.header) + n.node("table", f + n.node("tbody", n.group({
      min: 0, max: 5, i: 1, node: "tr", item: function (t) {
  ...
  selectMonths: !0, selectYears: 15, onRender: function () {
    var t = this.$root, e = this.get("highlight", "yyyy"), i = this.get("highlight", "dd"), n = this.get("highlight", "mmm"), o = this.get("highlight", "dddd");
  ...
  var t, e, i, n = window.jQuery, o = n(window), a = n(document), r = "http://www.w3.org/2000/svg", s = "SVGAngle" in window && ((e = document.createElement("div")).innerHTML = "<svg/>", t = (e.firstChild && e.firstChild.namespaceURI) == r, e.innerHTML = "", t), l = "transition" in (i = document.createElement("div").style) || "WebkitTransition" in i || "MozTransition" in i || "msTransition" in i || "OTransition" in i, c = "ontouchstart" in window, u = "mousedown" + (c ? " touchstart" : ""),
    d = "mousemove.clockpicker" + (c ? " touchmove.clockpicker" : ""), h = "mouseup.clockpicker" + (c ? " touchend.clockpicker" : ""), p = navigator.vibrate ? "vibrate" : navigator.webkitVibrate ? "webkitVibrate" : null;
  ...
  function C(t, e) {
    var i, o, r = n(S), l = r.find(".clockpicker-plate"), c = r.find(".picker__holder"), p = r.find(".clockpicker-hours"), C = r.find(".clockpicker-minutes"), M = r.find(".clockpicker-am-pm-block"), I = "INPUT" === t.prop("tagName"), P = I ? t : t.find("input"), A = (P.prop("type"), n("label[for=" + P.attr("id") + "]")), _ = this;
    ...
    if (e.twelvehour) for (D = 0; D < 12; D += e.hourstep) E = F.clone(), L = D / 6 * Math.PI, R = y, E.css("font-size", "140%"), E.css({left: v + Math.sin(L) * R - x, top: v - Math.cos(L) * R - x}), E.html(0 === D ? 12 : D), p.append(E), E.on(u, V); else for (D = 0; D < 24; D += e.hourstep) {
    ...
    for (D = 0; D < 60; D += W) for (D = 0; D < 60; D += 5) E = F.clone(), L = D / 30 * Math.PI, E.css({left: v + Math.sin(L) * y - x, top: v - Math.cos(L) * y - x}), E.css("font-size", "140%"), E.html(m(D)), C.append(E), E.on(u, V);

    function V(t, i) {
      var n = l.offset(), o = /^touch/.test(t.type), r = n.left + v, c = n.top + v, u = (o ? t.originalEvent.touches[0] : t).pageX - r, p = (o ? t.originalEvent.touches[0] : t).pageY - c, f = Math.sqrt(u * u + p * p), m = !1;
      if (!i || !(f < y - x || f > y + x)) {
        t.preventDefault();
        ...
        s && l.append(_.canvas), _.setHand(u, p, !i, !0), a.off(d).on(d, function (t) {
          t.preventDefault();
          var e = /^touch/.test(t.type), i = (e ? t.originalEvent.touches[0] : t).pageX - r, n = (e ? t.originalEvent.touches[0] : t).pageY - c;
          (m || i !== u || n !== p) && (m = !0, _.setHand(i, n, !1, !0))
        }), a.off(h).on(h, function (t) {
          a.off(h), t.preventDefault();
          var n = /^touch/.test(t.type), o = (n ? t.originalEvent.changedTouches[0] : t).pageX - r, s = (n ? t.originalEvent.changedTouches[0] : t).pageY - c;
  ...
  C.DEFAULTS = {default: "", fromnow: 0, donetext: "Done", autoclose: !1, ampmclickable: !1, darktheme: !1, twelvehour: !1, vibrate: !0, hourstep: 1, minutestep: 1, ampmSubmit: !1}, C.prototype.toggle = function () {
    ...
    var e = this.currentView, i = this[e], n = "hours" === e, o = i * (Math.PI / (n ? 6 : 30)), a = n && i > 0 && i < 13 ? b : y, r = Math.sin(o) * a, l = -Math.cos(o) * a, c = this;
  ...
  return function (t, e, i, n) {
    ...
    o.extend(r, n);
    var s, l, c, u, d, h, p, f, m, g, v, y, b, x, w, k, S, C, T, M, I, P, A, _, O, D, E, L, R, F, $, W, V, z, N, H, j, B, Y, X, q, U, Q, Z, K, G, J, tt, et, it, nt, ot, at, rt, st, lt = {x: 0, y: 0}, ct = {x: 0, y: 0}, ut = {x: 0, y: 0}, dt = {}, ht = 0, pt = {}, ft = {x: 0, y: 0}, mt = 0, gt = !0, vt = [], yt = {}, bt = !1, xt = function (t, e) {
    ...
    }, Kt = {}, Gt = {}, Jt = {}, te = {}, ee = {}, ie = [], ne = {}, oe = [], ae = {}, re = 0, se = {x: 0, y: 0}, le = 0, ce = {x: 0, y: 0}, ue = {x: 0, y: 0}, de = {x: 0, y: 0}, he = function (t, e) {
      ...
      if (!("mousedown" === t.type && t.button > 0)) {
        ...
        if (!j || "mousedown" !== t.type) {
          ...
          Z = null, Ut(), B && 1 !== n || (B = nt = !0, o.bind(window, p, a), N = rt = ot = H = Q = q = Y = X = !1, it = null, Ct("firstTouchStart", i), Et(ct, ut), lt.x = lt.y = 0, Et(te, i[0]), Et(ee, te), ne.x = ft.x * ht, oe = [{x: te.x, y: te.y}], V = W = Tt(), $t(g, !0), pe(), fe()), !K && n > 1 && !et && !Q && (v = g, X = !1, K = Y = !0, lt.y = lt.x = 0, Et(ct, ut), Et(Kt, i[0]), Et(Gt, i[1]), be(Kt, Gt, de), ue.x = Math.abs(de.x) - ut.x, ue.y = Math.abs(de.y) - ut.y, G = he(Kt, Gt))
        }
      }
    }, Ie = function (t) {
      ...
      1 === l && Et(ee, s[0]), 0 !== l || it || et || (e || ("mouseup" === t.type ? e = {x: t.pageX, y: t.pageY, type: "mouse"} : t.changedTouches && t.changedTouches[0] && (e = {x: t.changedTouches[0].pageX, y: t.changedTouches[0].pageY, type: "touch"})), Ct("touchRelease", t, e));
      var c = -1;
      ...
      var t, e, i = {
        lastFlickOffset: {}, lastFlickDist: {}, lastFlickSpeed: {}, slowDownRatio: {}, slowDownRatioReverse: {}, speedDecelerationRatio: {}, speedDecelerationRatioAbs: {}, distanceOffset: {}, backAnimDestination: {}, backAnimStarted: {}, calculateSwipeSpeed: function (n) {
    ...
    var Re, Fe, $e, We, Ve, ze, Ne = function (e, i, n, s) {
      ...
      if (t.src && !t.loadError) {
        var n = !i;
        if (n && (t.vGap || (t.vGap = {top: 0, bottom: 0}), Ct("parseVerticalMargin", t)), He.x = e.x, He.y = e.y - t.vGap.top - t.vGap.bottom, n) {
        ...
        lazyLoadItem: function (t) {
          ...
          if (l) {
            ...
            if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), Ue(l), Ye(l, dt), !l.src || l.loadError || l.loaded) l.src && !l.loadError && ((n = o.createEl("pswp__img", "img")).style.opacity = 1, n.src = l.src, Qe(l, n), Xe(0, l, c, n)); else {
              if (l.loadComplete = function (i) {
                if (s) {
                  if (t && t.index === e) {
                    ...
                    i.imageAppended ? !We && i.placeholder && (i.placeholder.style.display = "none", i.placeholder = null) : $.transform && (et || We) ? je.push({item: i, baseDiv: c, img: i.img, index: e, holder: t, clearPlaceholder: !0}) : Xe(0, i, c, i.img, 0, !0)
                  }
              ...
              l.loading || qe(l), a.allowProgressiveImg() && (!$e && $.transform ? je.push({item: l, baseDiv: c, img: l.img, index: e, holder: t}) : Xe(0, l, c, l.img, 0, !0))
            }
  ...
  return function (t, e) {
    ...
    x.init = function () {
      ...
      return i.requestFullscreen ? e = {enterK: "requestFullscreen", exitK: "exitFullscreen", elementK: "fullscreenElement", eventK: n} : i.mozRequestFullScreen ? e = {enterK: "mozRequestFullScreen", exitK: "mozCancelFullScreen", elementK: "mozFullScreenElement", eventK: "moz" + n} : i.webkitRequestFullscreen ? e = {
        enterK: "webkitRequestFullscreen",
        exitK: "webkitExitFullscreen",
        elementK: "webkitFullscreenElement",
        eventK: "webkit" + n
      } : i.msRequestFullscreen && (e = {enterK: "msRequestFullscreen", exitK: "msExitFullscreen", elementK: "msFullscreenElement", eventK: "MSFullscreenChange"}), e && (e.enter = function () {
...
var initPhotoSwipeFromDOM = function (t) {
  for (var e = function (t) {
    ...
    if (a = function (t) {
      for (var e, i, n, o, a = t.childNodes, r = a.length, s = [], l = 0; l < r; l++) 1 === (e = a[l]).nodeType && (n = (i = e.children[0]).getAttribute("data-size").split("x"), o = {src: i.getAttribute("href"), w: parseInt(n[0], 10), h: parseInt(n[1], 10)}, e.children.length > 1 && (o.title = e.children[1].innerHTML), i.children.length > 0 && (o.msrc = i.children[0].getAttribute("src")), o.el = e, s.push(o));
      return s
    }(e), o = {
      galleryUID: e.getAttribute("data-pswp-uid"), getThumbBoundsFn: function (t) {
        var e = a[t].el.getElementsByTagName("img")[0], i = window.pageYOffset || document.documentElement.scrollTop, n = e.getBoundingClientRect();
...
initPhotoSwipeFromDOM(".mdb-lightbox"), function (t) {
  t.fn.sticky = function (e) {
    ...
    return this.each(function () {
      var e = t(this), a = e.outerHeight(), r = e.outerWidth(), s = i.topSpacing, l = i.zIndex, c = e.offset().top - s, u = t("<div></div>").width(r).height(a).addClass("sticky-placeholder"), d = i.stopper, h = t(window);
  ...
  1: [function (t, e, i) {
    ...
    }, i.startScrolling = n(o.add), i.stopScrolling = n(o.remove), i.env = {isWebKit: "undefined" != typeof document && "WebkitAppearance" in document.documentElement.style, supportsTouch: "undefined" != typeof window && ("ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch), supportsIePointer: "undefined" != typeof window && null !== window.navigator.msMaxTouchPoints}
  ...
  }, {"../instances": 18, "../update-geometry": 19, "../update-scroll": 20}], 11: [function (t, e, i) {
    "use strict";
    ...
    e.exports = function (t) {
      ...
      (function (t, e) {
        function i(i) {
          var o = a + i * e.railXRatio, r = Math.max(0, e.scrollbarXRail.getBoundingClientRect().left) + e.railXRatio * (e.railXWidth - e.scrollbarXWidth);
        ...
        function i(i) {
          var o = a + i * e.railYRatio, r = Math.max(0, e.scrollbarYRail.getBoundingClientRect().top) + e.railYRatio * (e.railYHeight - e.scrollbarYHeight);
    ...
    function n(t, e) {
      ...
      e.event.bind(e.ownerDocument, "selectionchange", function () {
        ...
        if (u) {
          var a = {x: e.pageX, y: e.pageY}, r = {left: t.offsetLeft, right: t.offsetLeft + t.offsetWidth, top: t.offsetTop, bottom: t.offsetTop + t.offsetHeight};
    ...
    "use strict";
    var n = t("../lib/helper"), o = t("../lib/class"), a = t("./instances"), r = t("./update-geometry"), s = {"click-rail": t("./handler/click-rail"), "drag-scrollbar": t("./handler/drag-scrollbar"), keyboard: t("./handler/keyboard"), wheel: t("./handler/mouse-wheel"), touch: t("./handler/touch"), selection: t("./handler/selection")}, l = t("./handler/native-scroll");
    ...
    var o = t("../lib/helper"), a = t("../lib/class"), r = t("./default-setting"), s = t("../lib/dom"), l = t("../lib/event-manager"), c = t("../lib/guid"), u = {};
    i.add = function (t) {
      var e = c();
      return function (t, e) {
  ...
  t(document).ready(() => {
    ...
    return this.$el = t(this), this.$document = t(document), this.eventsHandled = !1, this.defaultOptions = {data: [], placeholder: "", secondaryPlaceholder: ""}, this.selectors = {chips: ".chips", chip: ".chip", input: "input", delete: ".fa", selectedChip: ".selected"}, this.keyCodes = {
      enter: 13,
      backspace: 8,
      delete: 46,
      arrowLeft: 37,
      ...
      this.$document.on("click", this.selectors.chips, e => {
        ...
        const i = this.$document.find(this.selectors.chip + this.selectors.selectedChip), n = i.closest(this.selectors.chips), o = i.siblings(this.selectors.chip).length;
        if (!i.length) return;
        const a = e.which === this.keyCodes.backspace, r = e.which === this.keyCodes.delete, s = e.which === this.keyCodes.arrowLeft, l = e.which === this.keyCodes.arrowRight;
        ...
        const i = t(e.target), n = i.closest(this.selectors.chips), o = n.data("index"), a = n.children(this.selectors.chip).length;
        if (e.which === this.keyCodes.enter) return e.preventDefault(), this.addChip(o, {tag: i.val()}, n), void i.val("");
        const r = e.keyCode === this.keyCodes.arrowLeft || e.keyCode === this.keyCodes.delete, s = "" === i.val();
...
var objectFitImages = function () {
  "use strict";
  var t = "bfred-it:object-fit-images", e = /(object-fit|object-position)\s*:\s*([-.\w\s%]+)/g, i = "undefined" == typeof Image ? {style: {"object-position": 1}} : new Image, n = "object-fit" in i.style, o = "object-position" in i.style, a = "background-size" in i.style, r = "string" == typeof i.currentSrc, s = i.getAttribute, l = i.setAttribute, c = !1;
...
!function (t) {
  ...
  i.m = t, i.c = e, i.d = function (t, e, n) {
    ...
    if (i.r(n), Object.defineProperty(n, "default", {enumerable: !0, value: t}), 2 & e && "string" != typeof t) for (var o in t) i.d(n, o, function (e) {
      return t[e]
    }.bind(null, o));
    return n
  }, i.n = function (t) {
  ...
  (function (t) {
    ...
    var u = navigator.userAgent.indexOf("MSIE ") > -1 || navigator.userAgent.indexOf("Trident/") > -1 || navigator.userAgent.indexOf("Edge/") > -1, d = function () {
    ...
    var w = !!t.ResizeObserver && new t.ResizeObserver(function (t) {
      ...
      return o(t, [{
        ...
        key: "init", value: function () {
          var t = {position: "absolute", top: 0, left: 0, width: "100%", height: "100%", overflow: "hidden", pointerEvents: "none"}, e = {};
        ...
        key: "coverImage", value: function () {
          var t = this.image.$container.getBoundingClientRect(), e = t.height, i = this.options.speed, n = "scroll" === this.options.type || "scroll-opacity" === this.options.type, o = 0, a = e, r = 0;
          return n && (o = i < 0 ? i * Math.max(e, p) : i * (e + p), i > 1 ? a = Math.abs(o - p) : i < 0 ? a = o / i + Math.abs(o) : a += Math.abs(p - e) * (1 - i), o /= 2), this.parallaxScrollDistance = o, r = n ? (p - a) / 2 : (e - a) / 2, this.css(this.image.$item, {height: a + "px", marginTop: r + "px", left: "fixed" === this.image.position ? t.left + "px" : "0", width: t.width + "px"}), this.options.onCoverImage && this.options.onCoverImage.call(this), {
        ...
        key: "onScroll", value: function (t) {
          ...
          if (this.options.elementInViewport && (a = this.options.elementInViewport.getBoundingClientRect()), this.isElementInViewport = a.bottom >= 0 && a.right >= 0 && a.top <= p && a.left <= h, t || this.isElementInViewport) {
            var r = Math.max(0, i), s = Math.max(0, n + i), l = Math.max(0, -i), c = Math.max(0, i + n - p), u = Math.max(0, n - (i + n - p)), d = Math.max(0, -i + p - n), f = 1 - 2 * (p - i) / (p + n), m = 1;
